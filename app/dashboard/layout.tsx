...
// ─── DYNAMIC IMPORTS — évite le mismatch d'IDs Radix SSR/client ──────────────
...
// En production : remplacer par session?.user?.roles?.includes("CHEF_SERVICE")
  ...
  return (
    <div className="min-h-screen bg-background">
              ...
              >
                ...
                <ChevronDown
                  className={cn(
                    ...
                    chefSectionOpen ? "rotate-0" : "-rotate-90"
                  )}
      ...
      <div className="lg:pl-72">
        ...
        {/* Header — sans Radix UI direct, composants chargés en client-only */}
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-xs text-muted-foreground">
                Bienvenue sur le système SIGR
              </p>
            </div>
          </div>

          <div className="flex items-center gap-2">
            {/* Chargés sans SSR → plus de mismatch d'IDs Radix */}
