...
export default function CataloguePage() {
  ...
  const toggleCart = (productId: number, qty: number = 1) => {
    setCart((prev) => {
  ...
  const addToCartFromDialog = () => {
    if (selectedProduct) {
      setCart((prev) => {
        ...
        return [...prev, { id: selectedProduct.id, quantity }]
      })
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <Button className="w-fit bg-[#E31837] hover:bg-[#E31837]/90" asChild>
          <a href="/dashboard/panier">
          ...
          <Card className="border-0 shadow-sm">
            <CardContent className="p-4">
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                {/* Sub-category Filter for Mobile */}
                ...
                return (
                  <Card key={product.id} className="border-0 shadow-sm hover:shadow-md transition-shadow group overflow-hidden">
                    <CardContent className="p-4">
                      ...
                      <h3 
                        className="font-semibold text-sm mb-1 cursor-pointer hover:text-[#1D6F42] line-clamp-1"
                        onClick={() => openProductDetails(product)}
                      >
                        {product.name}
                      </h3>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 flex-wrap mb-1">
                            <h3 
                              className="font-semibold text-sm cursor-pointer hover:text-[#1D6F42]"
                              onClick={() => openProductDetails(product)}
                            >
                              {product.name}
                            </h3>
            ...
            <>
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="flex gap-2">
                  <Badge className="bg-[#1D6F42]/10 text-[#1D6F42] hover:bg-[#1D6F42]/20 border-0">
                    {selectedProduct.categoryLabel}
                  </Badge>
                  <Badge variant="outline" className="text-[#E31837] border-[#E31837]/30">
                    {selectedProduct.subCategoryLabel}
                  </Badge>
                </div>
              ...
              <DialogFooter className="gap-2 sm:gap-0">
                ...
                <Button 
                  className="bg-[#1D6F42] hover:bg-[#1D6F42]/90"
